...
def app(diabetes_df):
    ...
    bp = st.slider("Bp",float(diabetes_df['Blood_Pressure'].min()), float(diabetes_df['Blood_Pressure'].max()))
    ...
    pidegree = st.slider("Pidegree",float(diabetes_df['Pedigree_Function'].min()), float(diabetes_df['Pedigree_Function'].max()))
